        ...
        <Card className="w-full p-6 border border-gray-200 flex flex-col justify-between">
            <div className=" flex justify-between items-start gap-4">
                ...
                <div>
                    ...
                    <Button variant="ghostBlue" size="sm" className="font-medium" onClick={() => router.push('/app/profile')}>
                        Edit
                    </Button>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-2 p-4">
                <p className="text-sm font-semibold">Where are you in your job search?</p>
                ...
                <Select>
                    ...
                    <SelectContent className="bg-white">
                        ...
                        <SelectItem value="open-but-not-looking">Open but Not Looking</SelectItem>
