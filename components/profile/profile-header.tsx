...
const ProfileHeader = () => {
    ...
    const { handleSubmit: handleSubmitFiles, control: controlFiles, watch, formState } = useProfileFiles();
    ...
    const onDetailsSubmit = async () => {
        ...
        if (!result) {
            console.log("Validation failed, showing errors:", profileDetailsForm.formState.errors);
            return;
        }
            ...
            <div className="container">
                <div className="w-full flex items-center justify-between border-t border-b p-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        {
                            currentTab === "Profile" && <Button variant="primaryBlue" size="sm" className="font-medium" onClick={onDetailsSubmit}>Submit Profile</Button>
                        }
                        {
                            currentTab === "Files" && <Button variant="primaryBlue" size="sm" className="font-medium" onClick={handleSubmitFiles(onFileSubmit)}>Submit Files</Button>
                        }
