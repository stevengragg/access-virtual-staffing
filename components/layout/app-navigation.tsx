...
export type AppNavbarProps = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;
...
export const AppNavbarDefaults: AppNavbarProps = {
  logo: {
    url: "/",
    src: "/avs_logo_4.png",
  ...
  navLinks: [
    { title: "Overview", url: "/app/overview" },
    { title: "Profile", url: "/app/profile" },
    { title: "Find Work", url: "/jobs" },
  ],
  buttons: [
    {
      navLink: {
