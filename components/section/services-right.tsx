...
export type ServicesRightProps = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;

export const ServicesRight = (props: ServicesRightProps) => {
...
// export const ServicesRightDefaults: ServicesRightProps = {
