...
export const HeroHeader = (props: Header36Props) => {
  ...
  return (
    <section
      id="hero"
      className="grid grid-cols-1 items-center gap-y-16 pt-16 md:pt-24 lg:grid-cols-12 lg:pt-0 bg-primaryBlue lg:bg-primaryBlue/85 lg:bg-heroHeaderBg bg-center bg-no-repeat bg-cover lg:bg-blend-multiply"
    >
...
export const Header36Defaults: Header36Props = {
  heading: "Bridging Talent & Business Success, Crafted to Perfection",
  description:
    "At Access Virtual Staffing, we’re not just connecting you with talent; we’re aligning your business with the perfect fit.  We craft tailored solutions that empower your business to thrive. Your success is our mission, and we’re here to make it happen - seamlessly, confidently, and with a touch of care.",
  buttons: [
    {
      navLink: {
